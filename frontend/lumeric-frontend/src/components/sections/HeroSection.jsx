    ...
    <section id="home" className="relative px-0 pb-0 pt-[calc(var(--hero-navbar-offset)+0.32rem)]">
      <div className="mx-auto max-w-none">
        <div className="relative min-h-[calc(100vh-var(--hero-navbar-offset))] overflow-hidden bg-[var(--color-ink)]">
          ...
          <div className="relative z-10 flex min-h-[calc(100vh-var(--hero-navbar-offset))] items-center pt-12 max-lg:min-h-[calc(100svh-var(--hero-navbar-offset))] max-lg:items-end max-lg:pb-10 sm:pt-14 lg:pt-16">
            <div className="max-w-[37rem] px-4 max-lg:mx-auto max-lg:max-w-[42rem] max-lg:text-center sm:px-6 lg:ml-[clamp(2rem,6vw,5.5rem)] lg:px-0">
              <p
                data-hero-text
                className="mb-7 inline-flex items-center gap-3 border-b border-[rgba(255,255,255,0.22)] pb-3 text-[11px] font-semibold uppercase tracking-[0.3em] text-[rgba(255,255,255,0.74)] max-[480px]:mb-5 max-[480px]:tracking-[0.2em]"
              >
              ...
              <h1
                data-hero-text
                className="max-w-[10.5ch] font-['Inter'] text-[2.9rem] font-semibold leading-[0.92] tracking-[-0.05em] text-white max-lg:mx-auto max-lg:max-w-[11.5ch] max-lg:text-[clamp(3rem,10vw,5rem)] max-md:leading-[0.98] max-[480px]:text-[clamp(2.45rem,13vw,3.35rem)] sm:text-[4.2rem] lg:text-[5.4rem]"
              >
                Estetica facial,
                <br />
                corporal e
              ...
              <p
                data-hero-text
                className="mt-7 max-w-lg text-[15px] leading-7 text-[rgba(255,255,255,0.74)] max-lg:mx-auto max-lg:text-[clamp(0.96rem,2.6vw,1.08rem)] max-lg:leading-8 sm:text-[17px] sm:leading-8"
              >
