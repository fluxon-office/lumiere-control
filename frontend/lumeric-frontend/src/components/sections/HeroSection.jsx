    ...
    <section id="home" className="relative px-0 pb-0 pt-[calc(var(--hero-navbar-offset)+0.32rem)]">
      <div className="mx-auto max-w-none">
        <div className="relative min-h-[calc(100vh-var(--hero-navbar-offset))] overflow-hidden bg-[var(--color-ink)]">
          ...
          <div className="relative z-10 flex min-h-[calc(100vh-var(--hero-navbar-offset))] items-center pt-12 max-lg:min-h-[calc(100svh-var(--hero-navbar-offset))] max-lg:items-stretch max-lg:pb-10 max-lg:pt-10 sm:pt-14 lg:pt-16">
